...
| `HYPERCACHEIO_GO_UNIX_SOCKET` | Absolute path to a Unix Domain Socket to completely bypass TCP handshakes for local PHP -> Go communication | `storage_path('hypercacheio/hypercacheio.sock')` |
